    ...
    <el-col :span="24" class="topbar-wrap">
      ...
      <div class="topbar-account topbar-btn">
        <el-dropdown trigger="click">
           <span class="el-dropdown-link userinfo-inner"><i class="iconfont icon-user"></i><i
            class="iconfont icon-down"></i></span>
              <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
              <div @click="jumpTo('/usercenter')"><span style="color: #555;font-size: 14px;">个人信息</span></div>
            </el-dropdown-item>
